...
### 5–10. Case studies (`work/*.html`)
- `wade.html`, `mobilink.html`, `flever.html`, `inclusive.html`, `seuv.html`, `suv.html`
...
| `assets/works/*_cover.jpg` | Work grid cover images (6 works × 1) | ~120–260 KB each |
